...
def test_update_session_invalid_ended_at_date():
    ...
    try:
        ...
        assert body["details"] == "session started_at must be before session ended_at"
...
if __name__ == "__main__":
    test_update_session_invalid_ended_at_date()