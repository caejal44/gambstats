...
def test_update_game_completed_success():
    ...
    event = {
        ...
        "pathParameters": {
            "game_id": game_id},
        "body": json.dumps({
            "game_name": "China Street - Ultimate Fire Link",
            "cash_out": 245.67,
            "notes": "Dime Denom - 2.00 bets - 50 spins"
    })
    }
    ...
    try:
        ...
        assert body["game_name"] == "China Street - Ultimate Fire Link"
        assert body["cash_out"] == 245.67
        assert body["notes"] == "Dime Denom - 2.00 bets - 50 spins"
...
if __name__ == "__main__":
    test_update_game_completed_success()