...
def test_update_game_invalid_freeplay_used():
    ...
    try:
        ...
        assert body["details"] == "freeplay_used must be greater than 0 if cash_in equals 0"
...
if __name__ == "__main__":
    test_update_game_invalid_freeplay_used()